      ...
      class g {
        ...
        static parseStyle(e) {
          return e.split(";").reduce((e, g) => {
            ...
            h &&
              g.length &&
              (e[h.replace(/-([a-z])/g, (d) => d[1].toUpperCase())] = g.join(
                ":"
              ));
            return e;
          }, {});
    ...
    function (a, y, I, L, C, z, H, B) {
      ...
      class Y {
        ...
        setTickInterval(c) {
          ...
          this.range &&
            e(this.max) &&
            ((this.userMin = this.min = w = Math.max(
              this.dataMin,
              this.minFromRange()
            )),
        ...
        getOffset() {
          ...
          t &&
            ...
            ja &&
              !K &&
              !1 !== t.reserveSpace &&
              ((c.titleOffset = u = c.axisTitle.getBBox()[
                a ? "height" : "width"
              ]),
              (x = t.offset),
        ...
        destroy(b) {
          ...
          for (const b in c.plotLinesAndBandsGroups)
            c.plotLinesAndBandsGroups[b] = c.plotLinesAndBandsGroups[
              b
            ].destroy();
          P(c, function (b, f) {
      ...
      class p {
        ...
        render() {
          ...
          (g = m.plotLinesAndBandsGroups[X]) ||
            (m.plotLinesAndBandsGroups[X] = g = k
              .g("plot-" + X)
              .attr(d)
              .add());
              ...
              if (b && r) {
                ...
                if (u)
                  if (E) E[f ? "animate" : "attr"]({ x: u.x, y: u.y });
                    ...
                    h &&
                      ((c.stateMarkerGraphic = E = w.renderer
      ...
      class F {
        ...
        drop(a) {
          ...
          if (this.selectionMarker) {
            const { x: k, y: b, width: f, height: c } = this.getSelectionBox(
      ...
      class G {
            ...
            this.allItems.forEach(function (f) {
              ...
              e &&
                ...
                m(e, {
                  ...
                  top: g + "px",
                  display:
                    this.proximate || (g > d - 6 && g < d + a - 6) ? "" : "none"
                }));
            }, this));
        }
        renderTitle() {
        ...
        handleOverflow(b) {
          ...
          b && 0 < k && b > k && !1 !== q.enabled
            ? ((this.clipHeight = x = Math.max(
                k - 20 - this.titleHeight - l,
                0
              )),
      ...
      class aa {
        ...
        setVisible(b, a) {
          const c = this,
            ...
            e = c.visible,
            g = (c.visible = b = c.options.visible = c.userOptions.visible =
        ...
        select(b) {
          this.selected = b = this.options.selected =
    ...
    function (a, y, I, L, C, z, H, B, u, v, l, p, t) {
      ...
      class ea {
        ...
        getContainer() {
          ...
          this.renderer = new (a.renderer || !q
            ? H.getRendererType(a.renderer)
            : v)(
            f,
            l,
            m,
    ...
    function (a, y, I, L, C, z) {
      ...
      I.prototype.moveFixedElements = function () {
        let a = this.container,
          ...
          h = ".highcharts-breadcrumbs-group .highcharts-contextbutton .highcharts-legend .highcharts-legend-checkbox .highcharts-navigator-series .highcharts-navigator-xaxis .highcharts-navigator-yaxis .highcharts-navigator .highcharts-reset-zoom .highcharts-drillup-button .highcharts-scrollbar .highcharts-subtitle .highcharts-title".split(
            " "
          ),
          g;
